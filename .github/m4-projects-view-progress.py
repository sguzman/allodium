...
path = Path('.project/issues/issue-0011/body.md')
text = path.read_text()
marker = '## Design constraints\n'
if marker not in text:
    raise SystemExit('issue-0011 design-constraints marker not found')
if '## Projects managed view creation progress' in text:
    raise SystemExit('ProjectV2 managed-view progress already recorded')

section = '''## Projects managed view creation progress
